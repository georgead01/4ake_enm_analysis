...
extern int molfile_lammpsyamlplugin_init(void);
extern int molfile_lammpsyamlplugin_register(void *, vmdplugin_register_cb);
extern int molfile_lammpsyamlplugin_fini(void);
...
extern int molfile_tprplugin_init(void);
extern int molfile_tprplugin_register(void *, vmdplugin_register_cb);
extern int molfile_tprplugin_fini(void);
...
#define MOLFILE_REGISTER_ALL(v, cb) \
    ...
    molfile_lammpsyamlplugin_register(v, cb); \
    ...
    molfile_tprplugin_register(v, cb); \
