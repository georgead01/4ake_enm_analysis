...
##
## $Id: rmsd.tcl,v 1.9 2022/07/04 23:52:39 johns Exp $
##
...
proc ::RMSDTool::rmsdtool {} {
  ...
  grid $calc_top -in $w -sticky new -padx 1 -pady 1
  ...
  #pack $rc_win.selfr.sel -side top -fill both -expand 1
  grid $calc_top.left -in $calc_top -sticky news -row 0 -column 0
  grid $rc_win -in $calc_top.left -sticky news
  grid $rc_win.selfr -in $rc_win -sticky news -column 0 -row 0 -columnspan 2 -padx 4 -pady 4
  grid $rc_win.bb -in $rc_win -sticky sew -column 0 -row 1 -pady 1
  grid $rc_win.selectionhistory -in $rc_win -sticky sew -column 1 -row 1 -pady 1
  grid $rc_win.selfr.sel -in $rc_win.selfr -sticky news -column 0 -row 0 -rowspan 2
  grid rowconfigure $rc_win 0 -weight 3
  grid rowconfigure $rc_win 1 -weight 1
  grid rowconfigure $rc_win.selfr 0 -weight 3
  grid rowconfigure $rc_win.selfr 1 -weight 1
  grid columnconfigure $rc_win.selfr 0 -weight 1
  ...
  grid $calc_top.right -in $calc_top -sticky news -row 0 -column 1
  grid $calc_top.right.pushfr -in $calc_top.right -sticky new -row 0 -column 0
  grid $calc_top.right.rmsd -in $calc_top.right.pushfr -sticky new -column 0 -row 0
  grid $calc_top.right.align -in $calc_top.right.pushfr -sticky new -column 1 -row 0
  grid columnconfigure $calc_top.right.pushfr 0 -weight 1
  grid columnconfigure $calc_top.right.pushfr 1 -weight 1
  grid $calc_top.right.switch -in $calc_top.right -sticky sew
  grid $calc_top.right.switch.0 -in $calc_top.right.switch -sticky ew -padx 2 -pady 2 -column 0 -row 0
  grid $calc_top.right.switch.1 -in $calc_top.right.switch -sticky ew -padx 2 -pady 2 -column 1 -row 0
  grid $calc_top.right.switch.2 -in $calc_top.right.switch -sticky ew -padx 2 -pady 2 -column 2 -row 0
  ...
  grid $calc_mid.titlebar.left -in $calc_mid.titlebar -column 0 -row 0 -sticky news
  
  frame $calc_mid.titlebar.right -bg $calc_bgcol
  grid rowconfigure    $calc_mid.titlebar 0	 -pad 0  -weight 100
  grid columnconfigure $calc_mid.titlebar 1  -pad 0  -weight 100
  grid $calc_mid.titlebar.right -in $calc_mid.titlebar -column 1 -row 0 -sticky news
  ...
  # Grid the bottom part widgets.
  grid $calc_mid.titlebar.left.label -in $calc_mid.titlebar.left -sticky w -row 0 -column 0
  grid $calc_mid.titlebar.right.label -in $calc_mid.titlebar.right -sticky ew -row 0 -column 1
  grid $calc_mid -in $w -row 1 -sticky news
  grid $calc_mid.titlebar -in $calc_mid -sticky new -row 0 -column 0 -columnspan 3
  grid columnconfigure $calc_mid 0 -weight 1
  grid columnconfigure $calc_mid 1 -weight 1
  grid columnconfigure $calc_mid 2 -weight 1
  grid columnconfigure $calc_mid.titlebar 0 -weight 1
  grid columnconfigure $calc_mid.titlebar 1 -weight 1
  grid columnconfigure $calc_mid.titlebar 2 -weight 1
  grid columnconfigure $calc_mid.titlebar.left 0 -weight 1
  grid columnconfigure $calc_mid.titlebar.right 0 -weight 1

  grid $rms_disp -in $w.middle -row 1 -column 0 -sticky news -columnspan 3
  grid $rms_disp.left -in $rms_disp -sticky news -column 0 -row 0
  grid $rms_disp.right -in $rms_disp -sticky news -column 1 -row 0
  grid columnconfigure $rms_disp 0 -weight 3
  grid columnconfigure $rms_disp 1 -weight 3
  grid columnconfigure $rms_disp.left 0 -weight 3
  grid columnconfigure $rms_disp.right 0 -weight 3
  grid $rms_disp.scrbar -in $rms_disp -sticky nsw -column 2 -row 0 
  grid $pdb_list -in $rms_disp.left -sticky news -column 0 -row 0
  grid $rmstot_lbl -in $rms_disp.left -sticky news -column 0 -row 1
  grid $rms_list -in $rms_disp.right -sticky news -column 0 -row 0
  grid $rmstot_val -in $rms_disp.right -sticky news -column 0 -row 1
  ...
  grid $w.bottom -in $w -sticky sew -column 0 -row 2 -columnspan 4
  grid $w.bottom.erase -in $w.bottom -sticky news -column 0 -row 0
  grid $w.bottom.allinmem -in $w.bottom -sticky news -column 1 -row 0
  grid $w.bottom.onlyactive -in $w.bottom -sticky news -column 2 -row 0
  grid $w.bottom.assemblymenu -in $w.bottom -sticky news -column 3 -row 0
  grid columnconfigure $w.bottom 0 -weight 1
  grid columnconfigure $w.bottom 1 -weight 1
  grid columnconfigure $w.bottom 2 -weight 1
  grid columnconfigure $w.bottom 3 -weight 1
