...
############################################################################
#
# $Id: export_options.tcl,v 1.7 2021/12/03 22:37:38 mariano Exp $
#
...
namespace eval MultiSeq::Export {
    ...
    proc showExportOptionsDialog {parent} {
        ...
        grid $w.center.g2.b             -sticky news
        ...
        grid $w.bottom.buttons.cancel   -row 0 -column 1 -sticky news -pady 5
